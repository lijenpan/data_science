...
def clean_data(df, feature):
    """
    function clean the data by removing unwanted words, patterns and punctuations
...
# ENCODER SECTION #
def extract_features(df, feature, normalization_mthd='Lemmatization', mode='Term Frequency',
